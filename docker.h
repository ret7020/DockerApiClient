...
json exec_in_container(string id, string bash_command, bool AttachStdin=true, bool AttachStdout=true, bool AttachStderr=true, bool tty=true, string working_dir="/", string host="http://localhost/v1.41");
